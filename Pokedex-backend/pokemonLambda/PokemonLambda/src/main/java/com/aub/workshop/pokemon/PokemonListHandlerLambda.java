...
public class PokemonListHandlerLambda implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        Map<String, AttributeValue> lastKeyEvaluated = decodeLastEvaluatedKeyFromParameters(nextPage);
